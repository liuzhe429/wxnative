...
export default class TestListPage extends Component {
    ...
    constructor(props) {
        ...
        this._listData = this.genItemData(100);
    ...
    render() {
        console.log(this._listData,"datassss")
        const filteredData = this._listData;
